 ...
 * User: anlun
 */
interface FullConstructionUtils {
    val FULL_CONSTRUCTION_TAG: String
        get() = "full construction"
    val JUNK_TEXT: String
        get() = "A"

    fun getFullConstructionInsertPlaceMap(): Map<String, SmartInsertPlace> =
    ...
    fun getFullConstructionTagPlaceToLineNumberMap(): Map<TagPlaceLine, Int> {
        val contentRelation = getContentRelation(JUNK_TEXT, getFullConstructionInsertPlaceMap())
        return contentRelation.first
    }

    fun getFullConstructionLineEquationMap(): Map<Int, LineEquation> {
        val contentRelation = getContentRelation(JUNK_TEXT, getFullConstructionInsertPlaceMap())
        return contentRelation.second
    }

    fun getContentRelation(
